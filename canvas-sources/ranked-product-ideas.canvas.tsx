...
// Все 50 нормализованных объектов и investor explanations встроены ниже; внешних данных нет.
type Idea = any;
const ideas: Idea[] = [
  {
    ...
    "simpleExplanation": "Это финансовая панель для владельца или финансового директора ресторанной сети. Она ежедневно собирает данные банков, 1С и касс, заменяя недельную ручную сверку актуальными отчётами о прибыли, движении денег и кассовых разрывах.",
    "elevatorPitch": "Ресторанные сети на 3–30 точек часто видят реальную прибыль лишь через недели и вручную разбирают комиссии, переводы и налоги. Продукт соединяет банки, 1С и кассовые системы, чтобы ежедневно обновлять прибыль, движение денег и предупреждения о кассовом разрыве. Сеть платит 40–150 тысяч рублей в месяц, а ежедневное закрытие периода поддерживает постоянное использование. Высокая ставка повышает цену ошибок, а доступные интеграции делают запуск своевременным; ценность ещё предстоит подтвердить платными пилотами.",
    "investorHook": "Высокая ежедневная боль и подписной чек 40–150 тысяч рублей сочетаются с накопленной моделью аномалий ресторанных финансов.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочее место финансовой команды, возвращающей просроченные платежи корпоративных клиентов. Оно связывает счета, обещания оплаты и банковские поступления, превращая позднее ручное обнаружение долга в ежедневную очередь понятных действий.",
    "elevatorPitch": "Сервисные компании и дистрибьюторы с сотнями счетов теряют время и оборотный капитал, когда обещания оплаты остаются в почте, а поступления сверяются вручную. Продукт связывает счёт, обещание и платёж, ранжирует должников и готовит доказуемые напоминания с одобрением сотрудника. Цена 50–250 тысяч рублей в месяц опирается на ежедневную работу казначейства и растущую платёжную историю. Рынок автоматизации расчётов растёт, но пилоты должны доказать сокращение просрочки отдельно от сезонности.",
    "investorHook": "Ежедневное взыскание и граф «счёт—обещание—платёж» создают повторное использование, измеримый денежный эффект и защиту на локальных платёжных данных.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это кадровый документооборот для складов, франшиз и выездных команд, которым неудобны обычные корпоративные системы. Работодатель платит за подписание документов со слабого телефона и без постоянного интернета, заменяя бумажные поездки управляемым цифровым архивом.",
    "elevatorPitch": "Работодатели с 300–5 000 линейных сотрудников возят бумаги между десятками точек, а люди без корпоративной почты срывают сложную активацию. Продукт даёт мобильное подписание, очередь без интернета и обмен с 1С ЗУП, сокращая незавершённые кадровые события. Подписка 15–80 тысяч рублей в месяц плюс внедрение повторяется вместе с наймами и обязательными документами. Быстрый рост электронного кадрового документооборота открывает окно, хотя юридическую надёжность сценариев без связи нужно подтвердить.",
    "investorHook": "Быстрорастущий обязательный процесс остаётся неудобным для линейных работников без корпоративной почты, а библиотека кадровых сценариев и интеграция с 1С усиливают удержание.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Ресторанные группы 3–50 точек с 20+ поставщиками. Покупатель — Операционный директор или закупки; распознавание документов накладных, нормализация SKU заменяют проблему «Цена ингредиента и выход блюда меняются быстрее техкарт; счета и заказы сверяются вручную» результатом «каждая поставка обновляет цены и benchmark; еженедельный заказ проходит через продукт».",
    "elevatorPitch": "Узкий клиент — Ресторанные группы 3–50 точек с 20+ поставщиками; платит Операционный директор или закупки. Сегодня Цена ингредиента и выход блюда меняются быстрее техкарт; счета и заказы сверяются вручную. Рабочее место связывает распознавание документов накладных, нормализация SKU, variance техкарты, создавая результат: каждая поставка обновляет цены и benchmark; еженедельный заказ проходит через продукт. Бизнес опирается на цену 8–25 тыс. ₽ за точку/мес, повторное использование и канал POS-интеграторы, ресторанные бухгалтерии. Сейчас Core POS консолидирован, а рост смещается в данные и закупки; глобальный и российский отчёты одинаково выделяют invoice/food-cost overlay; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "В идее «Автопилот себестоимости и закупок ресторана» привлекательны острота боли 9/10 и накапливаемая защита: Граф соответствий поставщик-SKU-ингредиент-техкарта и benchmark цены/списаний.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это конвейер первичных документов для бухгалтерских аутсорсеров и компаний с большим документооборотом. Он проверяет реквизиты и дубли, предлагает проводку и оставляет бухгалтеру только исключения, заменяя ручную перепроверку готовой операцией.",
    "elevatorPitch": "Узкий клиент — Бухгалтерские аутсорсеры и группы SMB с 3 000–50 000 документов в месяц; платит Главный бухгалтер или операционный директор аутсорсера. Сегодня распознавание документов сам по себе не завершает работу: бухгалтер вручную проверяет реквизиты, дубли, статьи и проводки. Программа автоматизирует inbox, распознавание документов/VLM, проверки ИНН/сумм/дублей, создавая результат: исправления бухгалтеров улучшают правила конкретного клиента и повышают straight-through rate. Бизнес опирается на цену 5–15 ₽ за завершённый документ, минимум 50 тыс. ₽/мес, повторное использование и канал 1С-франчайзи, бухгалтерские аутсорсеры. Сейчас IDP вырос на 52%, но VLM коммодитизирует распознавание; ценность перемещается в законченный процесс; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Сильная сторона «входящие счета-автоматизация первички до готовой проводки» — острота боли 9/10, усиленная активом: Корпус исправлений и правила document-to-posting по вертикалям.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Сервисные подрядчики с 10–100 техниками в одной регулируемой специальности. Покупатель — Собственник или сервисный директор; schedule, work order заменяют проблему «Сертификаты и акты собираются вручную; пропущенный повторный осмотр теряет выручку и создаёт соответствие требованиям-риск» результатом «история актива и обязательные повторные осмотры создают календарный lock-in».",
    "elevatorPitch": "Узкий клиент — Сервисные подрядчики с 10–100 техниками в одной регулируемой специальности; платит Собственник или сервисный директор. Сегодня Сертификаты и акты собираются вручную; пропущенный повторный осмотр теряет выручку и создаёт соответствие требованиям-риск. Продукт объединяет schedule, work order, без интернета mobile, создавая результат: история актива и обязательные повторные осмотры создают календарный lock-in. Бизнес опирается на цену 1 500–4 000 ₽ за техника/мес, повторное использование и канал отраслевые СРО/ассоциации, поставщики оборудования. Сейчас Глобальный FSM растёт около 12%, а горизонтальные suites не окупают локальные формы малых regulated trades; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Для «ОС обязательного выездного сервиса» ключевой довод — острота боли 9/10; защиту создаёт Asset-service history и библиотека форм одной профессии.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются Субподрядчики MEP, огнезащиты и фасадов с 5–30 параллельными объектами. Генеральный или производственный директор оплачивает единый процесс — mobile без интернета capture, привязка к зоне/работе, сертификаты: ручная проблема «Доказательства работ разбросаны по чатам; пакет сдачи собирают постфактум, задерживая закрытие и деньги» сменяется результатом «каждый новый объект и обязательная сдача требуют повторного использования; шаблоны накапливаются».",
    "elevatorPitch": "Строительные субподрядчики ведут несколько объектов, но доказательства работ остаются в чатах и задерживают закрытие. Продукт связывает журналы, фото, сертификаты и акты в готовый пакет исполнительной документации, ускоряя приёмку и оплату. Клиент платит 30–150 тысяч рублей в месяц либо за проект; шаблоны специальности накапливаются с каждым объектом. Импортозамещение и фрагментированный рынок создают окно, хотя результат зависит от принятия пакета заказчиком.",
    "investorHook": "Инвестиционный тезис «ОС исполнительной документации для строительного субподрядчика»: острота боли 9/10 плюс накопительный актив — Шаблоны и data model конкретной специальности плюс история доказательств, связанная с оплатой.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: дети 7–9 с отставанием. Для учитель, учебный центр или школа оно объединяет голосовую оценку, десятиминутную практику, отчёт и переводит работу от проблемы «учитель не может часто измерять навык» к повторяемому итогу: daily→weekly measure.",
    "elevatorPitch": "Целевая аудитория — дети 7–9 с отставанием, бюджет контролирует учитель, учебный центр или школа. Без продукта учитель не может часто измерять навык. Решение даёт голосовую оценку, десятиминутную практику, отчёт, после чего клиент получает daily→weekly measure; пилот проверяет «Для «голосовую оценку + десятиминутную практику + отчёт»: F1 <0.9». Выручка строится на цене ₽300–700/child, регулярном использовании и дистрибуции через teachers/centers. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; отчётed: РФ ≈49,1 млрд ₽, TAM ≈150 млрд ₽; global $7,8–10,6 млрд, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«Тренажёр беглого чтения 1–2 класса» сочетает острота боли 9/10 с защитой через permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Региональные сети 20–300 точек и 300–5 000 линейный персонал сотрудников. Покупатель — Директор по обучению/операциям; микроуроки, без интернета mobile заменяют проблему «Корпоративная LMS фиксирует просмотр курса, но не подтверждает выполнение операции на рабочем месте» результатом «новые сотрудники, смены и регулярные проверки поддерживают частое использование».",
    "elevatorPitch": "Узкий клиент — Региональные сети 20–300 точек и 300–5 000 линейный персонал сотрудников; платит Директор по обучению/операциям. Сегодня Корпоративная LMS фиксирует просмотр курса, но не подтверждает выполнение операции на рабочем месте. Рабочее место связывает микроуроки, без интернета mobile, сменные задания, создавая результат: новые сотрудники, смены и регулярные проверки поддерживают частое использование. Бизнес опирается на цену 120–350 ₽ за активного сотрудника/мес, повторное использование и канал франчайзеры, операционные консультанты. Сейчас Enterprise LMS насыщен, но региональное/линейный персонал проникновение низко; искусственный интеллект снижает стоимость авторинга, повышая ценность проверки действия; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "В идее «Операционное обучение линейный персонал с проверкой навыка» привлекательны реализуемость первая версия 9/10 и накапливаемая защита: Библиотека проверяемых операционных стандартов и связь обучения с KPI точки.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это контроль качества корпоративных помощников, отвечающих по внутренним документам. ИТ-служба платит за проверку прав доступа, ссылок и свежести, чтобы убедительные, но ошибочные ответы обнаруживались до ущерба сотрудникам.",
    "elevatorPitch": "Компании с внутренними помощниками не замечают, когда ответ основан на устаревшем документе или раскрывает закрытый источник. Продукт регулярно тестирует права, цитаты и свежесть, сравнивает результат после смены модели и назначает исправление владельцу знания. Годовая подписка 2–8 миллионов рублей оправдывается каждым обновлением индекса и прав; корпус проверок создаёт защиту. Внедрение помощников ускоряется, а проблема происхождения ответа остаётся, хотя бюджет и доверие требуют корпоративных пилотов.",
    "investorHook": "Сильная сторона «Контур надёжности корпоративного поиск ответов по внутренним документам» — экспортный потенциал 10/10, усиленная активом: Permission-aware eval corpus и regression history.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: подписной сервис/искусственный интеллект-компании с расходом 3–100 млн ₽ в месяц на 2+ облака/модели. Покупатель — технический директор/финансовый директор; billing ingest, allocation tags заменяют проблему «Cloud bills не связываются с клиентом и успешной искусственный интеллект-задачей; native tools раздельны» результатом «ежедневный variable bill и накопленные allocation правила».",
    "elevatorPitch": "Узкий клиент — подписной сервис/искусственный интеллект-компании с расходом 3–100 млн ₽ в месяц на 2+ облака/модели; платит технический директор/финансовый директор. Сегодня Cloud bills не связываются с клиентом и успешной искусственный интеллект-задачей; native tools раздельны. Продукт объединяет billing ingest, allocation tags, Kubernetes/языковые модели unit cost, создавая результат: ежедневный variable bill и накопленные allocation правила. Бизнес опирается на цену 1–3% managed spend, floor 100 тыс. ₽/мес, повторное использование и канал cloud MSP, Kubernetes integrators. Сейчас искусственный интеллект token/GPU spend reopened FinOps; local cloud billing lacks mature independent tooling; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Для «FinOps для искусственный интеллект, Kubernetes и локальных облаков» ключевой довод — экспортный потенциал 10/10; защиту создаёт Cross-vendor allocation graph from infrastructure to business outcome.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются Региональные перевозчики с 3–20 машинами и экспедиторы до 15 сотрудников. Собственник парка оплачивает единый процесс — заявки, калькулятор маржи, driver app: ручная проблема «Ставки и рейсы живут в чатах; собственник узнаёт реальную маржу после закрытия месяца» сменяется результатом «история ставок, расходов и дебиторки используется в каждом рейсе».",
    "elevatorPitch": "Узкий клиент — Региональные перевозчики с 3–20 машинами и экспедиторы до 15 сотрудников; платит Собственник парка. Сегодня Ставки и рейсы живут в чатах; собственник узнаёт реальную маржу после закрытия месяца. Система превращает заявки, калькулятор маржи, driver app в один управляемый процесс, создавая результат: история ставок, расходов и дебиторки используется в каждом рейсе. Бизнес опирается на цену 5–15 тыс. ₽/мес. за парк, повторное использование и канал топливные карты, бухгалтерии перевозчиков. Сейчас Платная база лидера выросла на 43%, а десятки тысяч микропарков остаются в чатах; ЭТрН создаёт обязательный цифровой триггер; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Инвестиционный тезис «TMS-lite и маржа рейса для парков 3–20 машин»: острота боли 9/10 плюс накопительный актив — История фактической маржи маршрутов и чрезвычайно простой процесс малого перевозчика.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Региональные дистрибьюторы с 20–200 водителями и собственной/подрядной доставкой. Покупатель — Директор логистики; dispatch, driver без интернета app заменяют проблему «Неуспешные доставки, возвраты и наложенный платёж сверяются вручную; универсальные TMS плохо учитывают отраслевые причины» результатом «каждый день заказов создаёт данные адресов и причин срыва, улучшая правила».",
    "elevatorPitch": "Узкий клиент — Региональные дистрибьюторы с 20–200 водителями и собственной/подрядной доставкой; платит Директор логистики. Сегодня Неуспешные доставки, возвраты и наложенный платёж сверяются вручную; универсальные TMS плохо учитывают отраслевые причины. Решение даёт dispatch, driver без интернета app, ETA, создавая результат: каждый день заказов создаёт данные адресов и причин срыва, улучшая правила. Бизнес опирается на цену 1 000–2 500 ₽ за водителя/мес. + внедрение, повторное использование и канал 1С-дистрибуционные интеграторы, фарма/FMCG ассоциации. Сейчас E-commerce и региональная дистрибуция растут, но локальные адреса/наложенный платёж сохраняют vertical gap; software-only модель не требует флота; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "«Контроль неуспешной доставки и наложенный платёж для дистрибьюторов» сочетает острота боли 9/10 с защитой через Адресная база, причины failure и отраслевые playbooks повторной доставки.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «Частные компании 200–2 000 сотрудников с 300+ активными поставщиками». Директор по закупкам или юридический директор покупает KYB snapshot, реестр договоров, извлечение обязательств, чтобы убрать текущую боль «Проверка контрагента разовая, а обязательства и продления ведутся в таблицах после подписи» и закрепить новый результат: продления и непрерывные проверки создают календарный recurring процесс.",
    "elevatorPitch": "Узкий клиент — Частные компании 200–2 000 сотрудников с 300+ активными поставщиками; платит Директор по закупкам или юридический директор. Сегодня Проверка контрагента разовая, а обязательства и продления ведутся в таблицах после подписи. Рабочее место связывает KYB snapshot, реестр договоров, извлечение обязательств, создавая результат: продления и непрерывные проверки создают календарный recurring процесс. Бизнес опирается на цену 80–300 тыс. ₽/мес. + внедрение, повторное использование и канал закупочные консультанты, 1С/ERP-интеграторы. Сейчас CLM растёт двузначно, а e-sign заканчивается на подписи; искусственный интеллект удешевляет extraction, но audit trail остаётся дефицитом; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "В идее «Паспорт поставщика и автопилот договорных обязательств» привлекательны повторяемость/retention 9/10 и накапливаемая защита: Подтверждённый граф поставщик—договор—обязательство—доказательство и история изменений.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Смешанные корпоративные парки 50–500 машин с двумя и более телематическими системами. Покупатель — Директор автопарка или логистики; hardware-agnostic ingestion, план ТО заменяют проблему «GPS-трекинг есть, но ремонты, шины и топливо живут отдельно; аномалии не доходят до закрытой задачи» результатом «история каждой машины и сезонные циклы ТО повышают switching cost».",
    "elevatorPitch": "Узкий клиент — Смешанные корпоративные парки 50–500 машин с двумя и более телематическими системами; платит Директор автопарка или логистики. Сегодня GPS-трекинг есть, но ремонты, шины и топливо живут отдельно; аномалии не доходят до закрытой задачи. Программа автоматизирует hardware-agnostic ingestion, план ТО, топливные/шинные аномалии, создавая результат: история каждой машины и сезонные циклы ТО повышают switching cost. Бизнес опирается на цену 400–1 200 ₽ за машину/мес, повторное использование и канал телематические интеграторы, СТО для корпоративных парков. Сейчас Трекинг стал commodity, OEM/входящие счетаI открывают asset-light слой, а глобальные и СНГ-отчёты выделяют maintenance/fuel gap; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Сильная сторона «Надстройка ремонта и топливных аномалий для смешанного автопарка» — острота боли 9/10, усиленная активом: Кросс-вендорная нормализация и benchmark поломок/аномалий по типам машин.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для узкого сегмента: владельцы питомцев с несколькими клиниками. Покупатель — ветклиника/insurer; он платит за распознавание документов, временная шкала, напоминания и сводка врачу, чтобы вместо ситуации «медистория разбросана» получить результат: document→визит→record.",
    "elevatorPitch": "Узкий клиент — владельцы питомцев с несколькими клиниками; платит ветклиника/insurer. Сегодня медистория разбросана. Продукт объединяет распознавание документов, временная шкала, напоминания и сводка врачу, создавая результат: document→визит→record. Эффект пилота проверяется условием «Для «распознавание документов + временная шкала + напоминания и сводка врачу»: D90 <25%». Бизнес опирается на цену ₽249–499/мес, канал клиники и страховые и повторный цикл; сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈3,5 млрд ₽; TAM ≈78,75 млрд ₽; global $1,5–4,2 млрд, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «Паспорт здоровья питомца» ключевой довод — острота боли 9/10; защиту создаёт permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются Бренды с GMV 50–500 млн ₽ на 2+ площадках. Собственник/e-commerce директор оплачивает единый процесс — true margin, ad anomalies, replenishment suggestions: ручная проблема «Нативные кабинеты не дают единую contribution margin; решения по рекламе и поставкам разорваны» сменяется результатом «ежедневные ads/stock решения и накопленная SKU history».",
    "elevatorPitch": "Узкий клиент — Бренды с GMV 50–500 млн ₽ на 2+ площадках; платит Собственник/e-commerce директор. Сегодня Нативные кабинеты не дают единую contribution margin; решения по рекламе и поставкам разорваны. Система превращает true margin, ad anomalies, replenishment suggestions в один управляемый процесс, создавая результат: ежедневные ads/stock решения и накопленная SKU history. Бизнес опирается на цену 30–150 тыс. ₽/мес. по GMV/SKU, повторное использование и канал агентства MP, банки seller ecosystem. Сейчас Рост топ-9 замедлился до 15.5%, native analytics давит dashboards; рынок явно смещается к action/outcome; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Инвестиционный тезис «ОС действий по прибыли продавца маркетплейсов»: капиталоэффективность 9/10 плюс накопительный актив — Нормализованная экономика SKU и журнал action→outcome.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: семьи с подростками и пожилыми. Для bank/telco/insurer оно объединяет share check, family alert, recovery и переводит работу от проблемы «непонятно как проверить угрозу» к повторяемому итогу: checks→threat graph.",
    "elevatorPitch": "Целевая аудитория — семьи с подростками и пожилыми, бюджет контролирует bank/telco/insurer. Без продукта непонятно как проверить угрозу. Решение даёт share check, family alert, recovery, после чего клиент получает checks→threat graph; пилот проверяет «Для «share check + family alert + recovery»: precision <90%». Выручка строится на цене ₽50–150/family B2B, регулярном использовании и дистрибуции через банки/telcos. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; отчётed: parental control $1,5 млрд 2024, forecast $3 млрд, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«Семейный антискам» сочетает острота боли 9/10 с защитой через permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «работники Central Asia→Russia». employer/staffing/bank покупает multilingual checklist, распознавание документов, сроки, чтобы убрать текущую боль «просрочки документов ведут к штрафам» и закрепить новый результат: monthly renewals.",
    "elevatorPitch": "Решение продаётся роли «employer/staffing/bank» для сегмента «работники Central Asia→Russia». Сейчас просрочки документов ведут к штрафам. Рабочее место связывает multilingual checklist, распознавание документов, сроки и создаёт проверяемый результат: monthly renewals; стоп-условие пилота — «Для «multilingual checklist + распознавание документов + сроки»: error >0.5%». Коммерческая модель — ₽150–400/worker, повторное использование и канал HoReCa/logistics employers. Момент входа связан с тем, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈4,5 млрд ₽, TAM ≈20 млрд ₽; global $0,8–1,4 млрд; масштабирование допустимо только после платного пилота.",
    "investorHook": "В идее «Компаньон трудового мигранта» привлекательны острота боли 9/10 и накапливаемая защита: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — Cloud-active компании 100–2 000 сотрудников с Kubernetes и без большой cloud-security команды. Бюджет держит директор по безопасности/технический директор: вместо проблемы «Сканеры создают сотни alerts без owner/remediation; локальные облака поддерживаются слабо» программа даёт posture ingest, policy packs, доказательства graph и результат «continuous drift и audit cycles».",
    "elevatorPitch": "Покупатель — директор по безопасности/технический директор, узкий клиент — Cloud-active компании 100–2 000 сотрудников с Kubernetes и без большой cloud-security команды. Главная потеря возникает потому, что Сканеры создают сотни alerts без owner/remediation; локальные облака поддерживаются слабо. Программа автоматизирует posture ingest, policy packs, доказательства graph; переход после внедрения — continuous drift и audit cycles, измеряемый условием «нет MSP anchor». Повторную выручку поддерживают цена 1.5–6 млн ₽ в год и канал MSSP/MSP, cloud integrators. Сейчас NIS2/CRA и рост локальных облаков создают обязательный spend; value смещается от alerts к remediation; инвестировать разумно после подтверждения результата и стоимости внедрения.",
    "investorHook": "Сильная сторона «Автоисправление облачного соответствие требованиям для mid-market» — экспортный потенциал 10/10, усиленная активом: Regional cloud policy graph and verified remediation library.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для узкого сегмента: эксперты с 5k–100k followers. Покупатель — creator/producer; он платит за audience import, база клиентов, receipts/export, чтобы вместо ситуации «платежи и отток разрознены» получить результат: segment→campaign→retained revenue.",
    "elevatorPitch": "Узкий клиент — эксперты с 5k–100k followers; платит creator/producer. Сегодня платежи и отток разрознены. Продукт объединяет audience import, база клиентов, receipts/export, создавая результат: segment→campaign→retained revenue. Эффект пилота проверяется условием «Для «audience import + база клиентов + receipts/export»: churn reduction <10%». Бизнес опирается на цену ₽1990–9990/month, канал creator agencies и повторный цикл; сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ net ≈0,75 млрд ₽, TAM ≈2,85 млрд ₽; global $1–2 млрд, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «база клиентов подписчиков Telegram-эксперта» ключевой довод — капиталоэффективность 9/10; защиту создаёт permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются guests of chains 3–30 locations. restaurant chain оплачивает единый процесс — reorder, margin triggers, holdouts: ручная проблема «повторный заказ остаётся у агрегатора» сменяется результатом «order→repeat→holdout».",
    "elevatorPitch": "Продукт создан для клиента «guests of chains 3–30 locations», покупатель — restaurant chain. Дорогой текущий разрыв: повторный заказ остаётся у агрегатора. Система превращает reorder, margin triggers, holdouts в один управляемый процесс; измеримый итог — order→repeat→holdout, а граница пилота задана как «Для «reorder + margin triggers + holdouts»: contribution <3x fee». Цена ₽8k–30k/location и канал POS integrators/franchises позволяют строить повторный бизнес. Окно открылось потому, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ delivery ≈76,5 млрд ₽, TAM ≈145 млрд ₽; software ≈6,75 млрд ₽; спрос и экономику ещё нужно подтвердить.",
    "investorHook": "Инвестиционный тезис «Автоповтор заказов ресторанов»: капиталоэффективность 9/10 плюс накопительный актив — permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: Региональные франшизы, ПВЗ и сети общепита/ритейла 20–300 точек. Для Операционный директор оно объединяет checklists, geo/time доказательства, искусственный интеллект photo правила и переводит работу от проблемы «Фотоотчёты создают ручную проверку, а нарушения не превращаются в закрытые задачи» к повторяемому итогу: регулярные аудиты и сравнительный рейтинг точек.",
    "elevatorPitch": "Целевая аудитория — Региональные франшизы, ПВЗ и сети общепита/ритейла 20–300 точек, бюджет контролирует Операционный директор. Без продукта Фотоотчёты создают ручную проверку, а нарушения не превращаются в закрытые задачи. Решение даёт checklists, geo/time доказательства, искусственный интеллект photo правила, после чего клиент получает регулярные аудиты и сравнительный рейтинг точек; пилот проверяет «precision CV <85%». Выручка строится на цене 500–2 000 ₽ за точку/мес, регулярном использовании и дистрибуции через франчайзеры, консультанты розницы. Сейчас Рынок растёт и привлекает M&A; CV переводит чек-лист из фиксации в обнаружение, а mid-market недообслужен, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«искусственный интеллект-аудит точек для региональных сетей» сочетает повторяемость/retention 9/10 с защитой через Размеченная библиотека нарушений одной вертикали.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «Частные сервисные и производственные компании 50–500 сотрудников без S2P». финансовый директор/директор по закупкам покупает intake, policy, quotes, чтобы убрать текущую боль «Заявки и КП теряются в почте, лимиты проверяются вручную, счёт не связан с согласованием» и закрепить новый результат: каждая незарплатная закупка и policy history.",
    "elevatorPitch": "Решение продаётся роли «финансовый директор/директор по закупкам» для сегмента «Частные сервисные и производственные компании 50–500 сотрудников без S2P». Сейчас Заявки и КП теряются в почте, лимиты проверяются вручную, счёт не связан с согласованием. Рабочее место связывает intake, policy, quotes и создаёт проверяемый результат: каждая незарплатная закупка и policy history; стоп-условие пилота — «adoption заявок <70%». Коммерческая модель — 50–200 тыс. ₽/мес, повторное использование и канал 1С-партнёры, финансовый директор communities. Момент входа связан с тем, что SMB slice растёт быстрее enterprise, а full S2P слишком тяжёл; РФ ЭТП зрелы, private intake gap остаётся; масштабирование допустимо только после платного пилота.",
    "investorHook": "В идее «Лёгкие закупки от заявки до сверки счёта» привлекательны повторяемость/retention 9/10 и накапливаемая защита: Policy templates и supplier performance history.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — Региональные сети услуг, клиник без медфункций, ресторанов и ритейла 10–100 точек. Бюджет держит Директор по маркетингу: вместо проблемы «Данные и отзывы на Яндекс/2ГИС разъезжаются, а влияние рейтинга на кассу не доказано» программа даёт listing sync, review triage, искусственный интеллект drafts и результат «постоянные отзывы/изменения и исторический benchmark».",
    "elevatorPitch": "Узкий клиент — Региональные сети услуг, клиник без медфункций, ресторанов и ритейла 10–100 точек; платит Директор по маркетингу. Сегодня Данные и отзывы на Яндекс/2ГИС разъезжаются, а влияние рейтинга на кассу не доказано. Программа автоматизирует listing sync, review triage, искусственный интеллект drafts, создавая результат: постоянные отзывы/изменения и исторический benchmark. Бизнес опирается на цену 1 000–3 000 ₽ за точку/мес, повторное использование и канал локальные агентства, POS/база клиентов партнёры. Сейчас Local search перемещается в карты и искусственный интеллект-ответы; сети требуют централизованного качества и измерения офлайн-эффекта; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Сильная сторона «Репутация и конверсия карт для сетей до 100 точек» — реализуемость первая версия 9/10, усиленная активом: Entity сопоставление точек и causal dataset reputation→sales.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Частные управляющие компании и девелоперские УК с 5–50 домами. Покупатель — Генеральный/операционный директор УК; intake, срок и качество сервиса routing заменяют проблему «Заявка закрыта в учёте, но качество, фото, срок и ответственность подрядчика не доказаны» результатом «история актива и подрядчика нужна при каждой повторной заявке».",
    "elevatorPitch": "Узкий клиент — Частные управляющие компании и девелоперские УК с 5–50 домами; платит Генеральный/операционный директор УК. Сегодня Заявка закрыта в учёте, но качество, фото, срок и ответственность подрядчика не доказаны. Продукт объединяет intake, срок и качество сервиса routing, contractor portal, создавая результат: история актива и подрядчика нужна при каждой повторной заявке. Эффект пилота проверяется условием «contractor activation <70%». Бизнес опирается на цену 15–50 ₽ за помещение/мес, канал девелоперы, эксплуатационные подрядчики и повторный цикл; сейчас Облачное ядро растёт, но maintenance/vendor layer фрагментирован; перенос объекта от девелопера добавляет данные, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «срок и качество сервиса-платформа обслуживания жилых комплексов» ключевой довод — повторяемость/retention 9/10; защиту создаёт История дефектов/подрядчиков и benchmark срок и качество сервиса.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются владельцы авто 3–10 лет. СТО/dealer/insurer оплачивает единый процесс — works, детали, напоминания: ручная проблема «нет переносимой истории» сменяется результатом «mileage→service→resale».",
    "elevatorPitch": "Продукт создан для клиента «владельцы авто 3–10 лет», покупатель — СТО/dealer/insurer. Дорогой текущий разрыв: нет переносимой истории. Система превращает works, детали, напоминания в один управляемый процесс; измеримый итог — mileage→service→resale, а граница пилота задана как «Для «works + детали + напоминания»: repeat <30%». Цена ₽299/owner или B2B PMPM и канал СТО/dealers/insurers позволяют строить повторный бизнес. Окно открылось потому, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈25 млрд ₽, TAM ≈100 млрд ₽; global SAM $2–4 млрд; спрос и экономику ещё нужно подтвердить.",
    "investorHook": "Инвестиционный тезис «Паспорт обслуживания автомобиля»: острота боли 9/10 плюс накопительный актив — permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: взрослые дети удалённо ухаживают за родителем. Для employer/bank/family оно объединяет роли, задачи, лекарства и переводит работу от проблемы «handoff и лекарства теряются» к повторяемому итогу: daily handoff→weekly отчёт.",
    "elevatorPitch": "Целевая аудитория — взрослые дети удалённо ухаживают за родителем, бюджет контролирует employer/bank/family. Без продукта handoff и лекарства теряются. Решение даёт роли, задачи, лекарства, после чего клиент получает daily handoff→weekly отчёт; пилот проверяет «Для «роли + задачи + лекарства»: WAU <45%». Выручка строится на цене ₽490–1490/семью, регулярном использовании и дистрибуции через HR benefits/private banking. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: global $4–7 млрд; SAM $1–2 млрд, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«Семейный штаб ухода за пожилым» сочетает острота боли 9/10 с защитой через permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «женщины 40–52 с длительными симптомами». клиника, страховщик или пользователь покупает временная шкала, формы, визит сводка, чтобы убрать текущую боль «симптомы непригодны врачу» и закрепить новый результат: check-in→визит→trend.",
    "elevatorPitch": "Решение продаётся роли «клиника, страховщик или пользователь» для сегмента «женщины 40–52 с длительными симптомами». Сейчас симптомы непригодны врачу. Рабочее место связывает временная шкала, формы, визит сводка и создаёт проверяемый результат: check-in→визит→trend; стоп-условие пилота — «Для «временная шкала + формы + визит сводка»: D30 <35%». Коммерческая модель — ₽590–1190/мес, повторное использование и канал клиники/employer wellbeing. Момент входа связан с тем, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈2,25 млрд ₽, TAM ≈37,2 млрд ₽; global $4–7 млрд; масштабирование допустимо только после платного пилота.",
    "investorHook": "В идее «Навигатор перименопаузы» привлекательны острота боли 9/10 и накапливаемая защита: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — самозанятые массажисты. Бюджет держит therapist/studio: вместо проблемы «неявки разрушают выручку курса» программа даёт course plan, депозит, лист ожидания и результат «next session→депозит→attendance».",
    "elevatorPitch": "Покупатель — therapist/studio, узкий клиент — самозанятые массажисты. Главная потеря возникает потому, что неявки разрушают выручку курса. Программа автоматизирует course plan, депозит, лист ожидания; переход после внедрения — next session→депозит→attendance, измеряемый условием «Для «course plan + депозит + лист ожидания»: no-show reduction <30%». Повторную выручку поддерживают цена ₽1490–3990/month и канал massage schools/acquiring. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ booking ≈2,5 млрд ₽, TAM ≈18 млрд ₽; global $1,2–1,9 млрд; инвестировать разумно после подтверждения результата и стоимости внедрения.",
    "investorHook": "Сильная сторона «Депозит и повторная запись массажиста» — капиталоэффективность 9/10, усиленная активом: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для узкого сегмента: пациенты с 4+ migraine days. Покупатель — neurology clinic/DMS; он платит за 60-sec log, exact-copy лекарства, визит сводка, чтобы вместо ситуации «бумажный дневник неполон» получить результат: episode→trend→review.",
    "elevatorPitch": "Узкий клиент — пациенты с 4+ migraine days; платит neurology clinic/DMS. Сегодня бумажный дневник неполон. Продукт объединяет 60-sec log, exact-copy лекарства, визит сводка, создавая результат: episode→trend→review. Эффект пилота проверяется условием «Для «60-sec log + exact-copy лекарства + визит сводка»: D90 <35%». Бизнес опирается на цену ₽400–900 PMPM, канал neurologists/DMS и повторный цикл; сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ telemedicine ≈16,5 млрд ₽, +17%; global broad $90–130 млрд, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «Мониторинг мигрени между визитами» ключевой довод — острота боли 9/10; защиту создаёт permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются русскоязычные сиделки и медсёстры. recruiter/employer/candidate оплачивает единый процесс — voice role-play and assessor calibration: ручная проблема «обычные приложения не знают рабочих ситуаций» сменяется результатом «daily→assessment→interview».",
    "elevatorPitch": "Продукт создан для клиента «русскоязычные сиделки и медсёстры», покупатель — recruiter/employer/candidate. Дорогой текущий разрыв: обычные приложения не знают рабочих ситуаций. Система превращает voice role-play and assessor calibration в один управляемый процесс; измеримый итог — daily→assessment→interview, а граница пилота задана как «Для «voice role-play and assessor calibration»: pass uplift <15pp». Цена ₽2500–7000/cohort и канал recruiters/colleges позволяют строить повторный бизнес. Окно открылось потому, что Canvas-источники фиксируют процесс gap и B2B2C-канал; отчётed: online language $22,1 млрд, self-learning SAM $14,2 млрд; спрос и экономику ещё нужно подтвердить.",
    "investorHook": "Инвестиционный тезис «Английский для собеседований caregivers»: острота боли 9/10 плюс накопительный актив — permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Регулируемый mid-market 200–2 000 сотрудников с 5–30 внутренними искусственный интеллект-автоматизациями. Покупатель — ИТ-директор/директор автоматизации; visual DAG, языковые модели steps заменяют проблему «n8n/скрипты дают действие без управляемого approval и доказательства, а cloud automation не проходит data residency» результатом «накопленные процессs и secrets создают switching cost».",
    "elevatorPitch": "Узкий клиент — Регулируемый mid-market 200–2 000 сотрудников с 5–30 внутренними искусственный интеллект-автоматизациями; платит ИТ-директор/директор автоматизации. Сегодня n8n/скрипты дают действие без управляемого approval и доказательства, а cloud automation не проходит data residency. Решение даёт visual DAG, языковые модели steps, secrets, создавая результат: накопленные процессs и secrets создают switching cost. Бизнес опирается на цену 1–5 млн ₽ в год + usage/support, повторное использование и канал IT-интеграторы, MSP. Сейчас No-code искусственный интеллект растёт 30.2%, agentic процессs требуют governance, а РФ имеет локальные connector gaps; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "«Self-hosted конструктор управляемых искусственный интеллект-процессов» сочетает рост категории 10/10 с защитой через Governance runtime и reliable local connectors.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «Сети с 100+ наймами линейный персонал в месяц». Руководитель массового подбора покупает messenger funnel, screening, slots, чтобы убрать текущую боль «Кандидаты теряются между откликом и сменой; generic ATS плохо работает в мессенджерах и не измеряет фактический выход» и закрепить новый результат: постоянная текучесть и накопленная статистика каналов.",
    "elevatorPitch": "Узкий клиент — Сети с 100+ наймами линейный персонал в месяц; платит Руководитель массового подбора. Сегодня Кандидаты теряются между откликом и сменой; generic ATS плохо работает в мессенджерах и не измеряет фактический выход. Рабочее место связывает messenger funnel, screening, slots, создавая результат: постоянная текучесть и накопленная статистика каналов. Бизнес опирается на цену 500–2 000 ₽ за подтверждённый выход или подписной сервис 100–400 тыс. ₽/мес, повторное использование и канал HR-аутсорсеры, франчайзеры. Сейчас Дефицит кадров поддерживает боль, но horizontal ATS bundle; outcome layer массового найма остаётся клином; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "В идее «ATS для массового почасового найма» привлекательны острота боли 9/10 и накапливаемая защита: Channel-to-shift outcome data и процесс конкретной сети.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — пациенты на назначенной терапии. Бюджет держит clinic/DMS/patient: вместо проблемы «побочные эффекты и потеря мышц снижают adherence» программа даёт protein, symptoms, тренировки и результат «daily→weekly→review».",
    "elevatorPitch": "Покупатель — clinic/DMS/patient, узкий клиент — пациенты на назначенной терапии. Главная потеря возникает потому, что побочные эффекты и потеря мышц снижают adherence. Программа автоматизирует protein, symptoms, тренировки; переход после внедрения — daily→weekly→review, измеряемый условием «Для «protein + symptoms + тренировки»: lift <10 pp». Повторную выручку поддерживают цена ₽990–1990/мес и канал obesity clinics/DMS. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; отчётed: apps $2,14 млрд; TAM $2,4–4 млрд; SAM $0,9–1,5 млрд; инвестировать разумно после подтверждения результата и стоимости внедрения.",
    "investorHook": "Сильная сторона «Компаньон сохранения мышц при терапии ожирения» — острота боли 9/10, усиленная активом: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для клиента: Переработчики, экспортёры и кооперативы, работающие с 50–500 хозяйствами ягод/теплиц/винограда. Покупатель — Директор по качеству или закупкам покупателя; без интернета records, input lots заменяют проблему «Покупатель собирает доказательства происхождения и химобработок вручную, а фермер не платит за общую FMS» результатом «каждый сезон и партия требуют непрерывной истории».",
    "elevatorPitch": "Узкий клиент — Переработчики, экспортёры и кооперативы, работающие с 50–500 хозяйствами ягод/теплиц/винограда; платит Директор по качеству или закупкам покупателя. Сегодня Покупатель собирает доказательства происхождения и химобработок вручную, а фермер не платит за общую FMS. Продукт объединяет без интернета records, input lots, field задачи, создавая результат: каждый сезон и партия требуют непрерывной истории. Эффект пилота проверяется условием «buyer не платит за пилот». Бизнес опирается на цену 1–4 млн ₽/год за buyer program, канал переработчики, агрономические консультанты и повторный цикл; сейчас Buyer-driven traceability создаёт бюджет и обходит слабый farmer WTP; рынок растёт около 11%, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «Прослеживаемость одной сельхозкультуры» ключевой довод — рыночное окно 9/10; защиту создаёт История поля-партии и шаблоны доказательств культуры.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются Независимые отели, базы отдыха и глэмпинги 20–150 номеров. Управляющий/операционный директор оплачивает единый процесс — room status, housekeeping board, maintenance: ручная проблема «PMS знает бронь, но сменные задачи, дефекты и готовность номера ведутся в чатах» сменяется результатом «ежедневная готовность номера и история дефектов».",
    "elevatorPitch": "Узкий клиент — Независимые отели, базы отдыха и глэмпинги 20–150 номеров; платит Управляющий/операционный директор. Сегодня PMS знает бронь, но сменные задачи, дефекты и готовность номера ведутся в чатах. Система превращает room status, housekeeping board, maintenance в один управляемый процесс, создавая результат: ежедневная готовность номера и история дефектов. Бизнес опирается на цену 200–600 ₽ за номер/мес, повторное использование и канал PMS marketplaces, hotel consultants. Сейчас Рынок РФ вырос на 25%, но лидер контролирует 60%; лучший вход — модуль, а не frontal PMS; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Инвестиционный тезис «Операции уборки и сервиса малых отелей»: повторяемость/retention 9/10 плюс накопительный актив — Room-operation benchmark и быстрые PMS connectors.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: владельцы питомцев в первые 7 дней после конкретной операции. Для ветклиника оно объединяет scheduled photos, checklist, clinic queue и переводит работу от проблемы «хаотичные сообщения задерживают обнаружение» к повторяемому итогу: daily prompt→passport upsell.",
    "elevatorPitch": "Целевая аудитория — владельцы питомцев в первые 7 дней после конкретной операции, бюджет контролирует ветклиника. Без продукта хаотичные сообщения задерживают обнаружение. Решение даёт scheduled photos, checklist, clinic queue, после чего клиент получает daily prompt→passport upsell; пилот проверяет «Для «scheduled photos + checklist + clinic queue»: staff time not -20%». Выручка строится на цене ₽300–800/surgery, регулярном использовании и дистрибуции через surgical clinics/insurers. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ PetTech ≈3,5 млрд ₽; global $1,5–4,2 млрд; post-op SAM unavailable, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«Фото-наблюдение питомца после операции» сочетает острота боли 9/10 с защитой через permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «небольшие операторы мастер-классов». operator/hotel покупает inventory, capacity, hotel входящие счетаI, чтобы убрать текущую боль «места и возвраты ведутся вручную» и закрепить новый результат: schedule→booking→repeat.",
    "elevatorPitch": "Решение продаётся роли «operator/hotel» для сегмента «небольшие операторы мастер-классов». Сейчас места и возвраты ведутся вручную. Рабочее место связывает inventory, capacity, hotel входящие счетаI и создаёт проверяемый результат: schedule→booking→repeat; стоп-условие пилота — «Для «inventory + capacity + hotel входящие счетаI»: <20 paid ops». Коммерческая модель — ₽3k–12k/month + fee, повторное использование и канал hotels/DMC. Момент входа связан с тем, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈15 млрд ₽, TAM ≈45 млрд ₽; global $3,5–5 млрд; масштабирование допустимо только после платного пилота.",
    "investorHook": "В идее «ОС гастрономических мастер-классов» привлекательны капиталоэффективность 9/10 и накапливаемая защита: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — ученики 8–9 классов. Бюджет держит parent/teacher/school: вместо проблемы «учителю не хватает rubric обратная связь» программа даёт обратная связь, карта ошибок, parent отчёт и результат «weekly answer→mastery».",
    "elevatorPitch": "Покупатель — parent/teacher/school, узкий клиент — ученики 8–9 классов. Главная потеря возникает потому, что учителю не хватает rubric обратная связь. Программа автоматизирует обратная связь, карта ошибок, parent отчёт; переход после внедрения — weekly answer→mastery, измеряемый условием «Для «обратная связь + карта ошибок + parent отчёт»: agreement <0.85». Повторную выручку поддерживают цена ₽390–790/student и канал teachers/schools. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; отчётed: РФ ≈19 млрд ₽, TAM ≈37,5 млрд ₽; global $2,2–7,7 млрд; инвестировать разумно после подтверждения результата и стоимости внедрения.",
    "investorHook": "Сильная сторона «искусственный интеллект-проверка письменной части ОГЭ» — капиталоэффективность 9/10, усиленная активом: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для узкого сегмента: семьи с newborns. Покупатель — maternity clinic/employer; он платит за shared handoff, docs, визитs, чтобы вместо ситуации «сон, лекарства и задачи передаются устно» получить результат: daily handoff→pediatric визит.",
    "elevatorPitch": "Узкий клиент — семьи с newborns; платит maternity clinic/employer. Сегодня сон, лекарства и задачи передаются устно. Продукт объединяет shared handoff, docs, визитs, создавая результат: daily handoff→pediatric визит. Эффект пилота проверяется условием «Для «shared handoff + docs + визитs»: partner use <25%». Бизнес опирается на цену ₽1k–3k/family, канал maternity clinics/benefits и повторный цикл; сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ family процесс ≈1,4 млрд ₽, TAM ≈4 млрд ₽; global $4–7 млрд, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «Навигатор первых 90 дней после рождения» ключевой довод — острота боли 9/10; защиту создаёт permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются Среднее производство и сервисные группы без ServiceNow-класса команды. ИТ-директор или директор по цифровизации оплачивает единый процесс — catalog templates, requests/incidents, approvals: ручная проблема «Простой help desk не поддерживает межфункциональные услуги, а enterprise ITSM внедряется месяцами» сменяется результатом «каталог и история активов становятся операционной системой внутренних услуг».",
    "elevatorPitch": "Узкий клиент — Среднее производство и сервисные группы без ServiceNow-класса команды; платит ИТ-директор или директор по цифровизации. Сегодня Простой help desk не поддерживает межфункциональные услуги, а enterprise ITSM внедряется месяцами. Система превращает catalog templates, requests/incidents, approvals в один управляемый процесс, создавая результат: каталог и история активов становятся операционной системой внутренних услуг. Бизнес опирается на цену 1–4 млн ₽ в год + partner setup, повторное использование и канал региональные IT-интеграторы, MSP. Сейчас Replacement cycle и ESM расширяют рынок; РФ растёт 15–20%, но 90% продаж on-prem и enterprise-heavy оставляют mid-market gap; эффект и экономику нужно подтвердить платным пилотом.",
    "investorHook": "Инвестиционный тезис «ESM для среднего бизнеса с запуском за неделю»: повторяемость/retention 9/10 плюс накопительный актив — Deployment automation и каталог шаблонов среднего бизнеса.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: владельцы 3–10-year appliances. Для ритейлер или производитель оно объединяет видеодиагностика, part, quote band и переводит работу от проблемы «мастер приезжает без нужной детали» к повторяемому итогу: repair→preventive reminder.",
    "elevatorPitch": "Целевая аудитория — владельцы 3–10-year appliances, бюджет контролирует ритейлер или производитель. Без продукта мастер приезжает без нужной детали. Решение даёт видеодиагностика, part, quote band, после чего клиент получает repair→preventive reminder; пилот проверяет «Для «видеодиагностика + part + quote band»: first-fix uplift <15pp». Выручка строится на цене ₽500–1200/job, регулярном использовании и дистрибуции через retailers/warranty. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈17 млрд ₽, TAM ≈140 млрд ₽; global $4–6 млрд, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«Видеодиагностика ремонта техники» сочетает острота боли 9/10 с защитой через permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «patients 55+ with 5+ лекарства». больница, страховщик или аптека покупает распознавание документов exact-copy, caregiver confirm, пополнение, чтобы убрать текущую боль «семья путает изменённую схему» и закрепить новый результат: daily confirmation→пополнение.",
    "elevatorPitch": "Решение продаётся роли «больница, страховщик или аптека» для сегмента «patients 55+ with 5+ лекарства». Сейчас семья путает изменённую схему. Рабочее место связывает распознавание документов exact-copy, caregiver confirm, пополнение и создаёт проверяемый результат: daily confirmation→пополнение; стоп-условие пилота — «Для «распознавание документов exact-copy + caregiver confirm + пополнение»: any critical error». Коммерческая модель — ₽300–800/discharge, повторное использование и канал hospitals/DMS. Момент входа связан с тем, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ e-pharma ≈69,5 млрд ₽, TAM ≈147 млрд ₽; category context; масштабирование допустимо только после платного пилота.",
    "investorHook": "В идее «Контроль лекарств после выписки» привлекательны острота боли 9/10 и накапливаемая защита: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — пассажиры с автобусными пересадками. Бюджет держит перевозчик или автостанция: вместо проблемы «задержка и пересадка непрозрачны» программа даёт carrier OS, pooled itinerary, bounded guarantee и результат «trip→punctuality graph».",
    "elevatorPitch": "Покупатель — перевозчик или автостанция, узкий клиент — пассажиры с автобусными пересадками. Главная потеря возникает потому, что задержка и пересадка непрозрачны. Программа автоматизирует carrier OS, pooled itinerary, bounded guarantee; переход после внедрения — trip→punctuality graph, измеряемый условием «Для «carrier OS + pooled itinerary + bounded guarantee»: support >₽80». Повторную выручку поддерживают цена ₽5k–20k/carrier + fee и канал carriers/stations. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈3,8 млрд ₽, TAM ≈9 млрд ₽; global $4–6 млрд; инвестировать разумно после подтверждения результата и стоимости внедрения.",
    "investorHook": "Сильная сторона «Гарантия пересадки на региональном автобусе» — острота боли 9/10, усиленная активом: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это программа для узкого сегмента: сотрудники после divorce. Покупатель — работодатель, программа помощи или пользователь; он платит за 6-week protocol, actions, group, чтобы вместо ситуации «между встречами нет структуры» получить результат: daily→weekly group.",
    "elevatorPitch": "Узкий клиент — сотрудники после divorce; платит работодатель, программа помощи или пользователь. Сегодня между встречами нет структуры. Продукт объединяет 6-week protocol, actions, group, создавая результат: daily→weekly group. Эффект пилота проверяется условием «Для «6-week protocol + actions + group»: completion <55%». Бизнес опирается на цену ₽6k–12k/participant, канал employers/Eвходящие счетаs и повторный цикл; сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈4,5 млрд ₽, broad TAM ≈126 млрд ₽; global $8–10 млрд, поэтому инвестиционный тезис требует платной проверки.",
    "investorHook": "Для «Восстановление после развода» ключевой довод — острота боли 9/10; защиту создаёт permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Продуктом пользуются путешественники после срыва поездки. банк, сервис бронирования или пользователь оплачивает единый процесс — itinerary inbox, правила, доказательства: ручная проблема «доказать возврат сложнее, чем купить поездку» сменяется результатом «trip→disruption→closure».",
    "elevatorPitch": "Продукт создан для клиента «путешественники после срыва поездки», покупатель — банк, сервис бронирования или пользователь. Дорогой текущий разрыв: доказать возврат сложнее, чем купить поездку. Система превращает itinerary inbox, правила, доказательства в один управляемый процесс; измеримый итог — trip→disruption→closure, а граница пилота задана как «Для «itinerary inbox + правила + доказательства»: automation <60%». Цена ₽490–1990/case и канал banks/OTAs позволяют строить повторный бизнес. Окно открылось потому, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ OTA net ≈65 млрд ₽, TAM ≈95 млрд ₽; category context; спрос и экономику ещё нужно подтвердить.",
    "investorHook": "Инвестиционный тезис «Ассистент возвратов после поездки»: острота боли 9/10 плюс накопительный актив — permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Решение адресовано клиенту: покупатели курсов и абонементов. Для consumer/bank оно объединяет доказательства, претензия, сроки и переводит работу от проблемы «малые claims дороги для юриста» к повторяемому итогу: deadline→collection.",
    "elevatorPitch": "Целевая аудитория — покупатели курсов и абонементов, бюджет контролирует consumer/bank. Без продукта малые claims дороги для юриста. Решение даёт доказательства, претензия, сроки, после чего клиент получает deadline→collection; пилот проверяет «Для «доказательства + претензия + сроки»: win <55%». Выручка строится на цене ₽990–2990 + success fee, регулярном использовании и дистрибуции через SEO/banks/unions. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈4 млрд ₽, TAM ≈15 млрд ₽; global $2–3,5 млрд, но инвестиция предполагает проверку, а не обещание доходности.",
    "investorHook": "«Возврат денег за неоказанные услуги» сочетает острота боли 9/10 с защитой через permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Это рабочий инструмент для клиента «пары, собирающие IVF документы». clinic/lab/employer покупает regional checklist, распознавание документов, expiry graph, чтобы убрать текущую боль «expiry dates and quotas fragmented» и закрепить новый результат: analysis→next step.",
    "elevatorPitch": "Решение продаётся роли «clinic/lab/employer» для сегмента «пары, собирающие IVF документы». Сейчас expiry dates and quotas fragmented. Рабочее место связывает regional checklist, распознавание документов, expiry graph и создаёт проверяемый результат: analysis→next step; стоп-условие пилота — «Для «regional checklist + распознавание документов + expiry graph»: wrong deadline >1%». Коммерческая модель — ₽1500–4000/case, повторное использование и канал IVF clinics/labs. Момент входа связан с тем, что Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ FemTech ≈2,25 млрд ₽, TAM ≈37,2 млрд ₽; no dedicated SAM; масштабирование допустимо только после платного пилота.",
    "investorHook": "В идее «Навигатор ОМС для ЭКО» привлекательны острота боли 9/10 и накапливаемая защита: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
  ...
  },
  {
    ...
    "simpleExplanation": "Целевой пользователь продукта — семьи, ремонтирующие жильё ₽1–5m. Бюджет держит владелец жилья, банк или магазин: вместо проблемы «изменения сметы скрываются в чатах» программа даёт estimate normalization, этапы, проверка эксперта и результат «milestone→handover referral».",
    "elevatorPitch": "Покупатель — владелец жилья, банк или магазин, узкий клиент — семьи, ремонтирующие жильё ₽1–5m. Главная потеря возникает потому, что изменения сметы скрываются в чатах. Программа автоматизирует estimate normalization, этапы, проверка эксперта; переход после внедрения — milestone→handover referral, измеряемый условием «Для «estimate normalization + этапы + проверка эксперта»: margin <50%». Повторную выручку поддерживают цена ₽14900–39900/project и канал banks/developers/DIY. Сейчас Canvas-источники фиксируют процесс gap и B2B2C-канал; estimate: РФ ≈17 млрд ₽, TAM ≈140 млрд ₽; global $4–6 млрд; инвестировать разумно после подтверждения результата и стоимости внедрения.",
    "investorHook": "Сильная сторона «Технический заказчик ремонта квартиры» — острота боли 9/10, усиленная активом: permissioned longitudinal процесс data, outcomes, partner integrations and trusted distribution.",
...
const validation = {
  ...
  "checks": {
    ...
    "pitchFieldsComplete": {
      "passed": true,
      "detail": "50/50 ideas contain non-empty simpleExplanation, elevatorPitch and investorHook."
    },
    "simpleExplanationLimits": {
      "passed": true,
      "detail": "50/50 were authored as 2 sentences and contain 25–55 words; observed 25–55 words."
    },
    "elevatorPitchLimits": {
      "passed": true,
      "detail": "50/50 were authored as 3–5 sentences and contain 55–100 words; observed 59–100 words."
    },
    "investorHookLimits": {
      "passed": true,
      "detail": "50/50 are non-empty and at most 28 words; observed maximum 28 words."
    },
    "pitchUniquenessAndConcepts": {
      "passed": true,
      "detail": "50 unique elevator pitches and 50 unique hooks; review covers target/buyer, pain, product/outcome, business model, and why-now with an investment caveat."
    }
  },
  "detectedIssues": [
    {
...
function ElevatorPitch({x}:{x:Idea}){return <Stack gap={10}><Divider/><H3>Суть идеи простыми словами</H3><Text>{x.simpleExplanation}</Text><Callout tone="info" title="Продажа в лифте: почему инвестировать">{x.elevatorPitch}</Callout><Text weight="semibold">{x.investorHook}</Text><Divider/></Stack>}
